...
func NewDockerPTYInit(t *testing.T) *TestContext {
	t.Helper()
	c := NewDockerPTY(t)
	initShell(t, c)
	return c
...
func newDockerContext(t *testing.T, usePTY bool) *TestContext {
	t.Helper()
...
func initShell(t *testing.T, c *TestContext) {
	t.Helper()
